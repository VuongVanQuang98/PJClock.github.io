                  ...
                  <li>
                    <table class="table table-striped">
                      ...
                      <!--   <tr>
                        ...
                        <tr>
                          <td class="text-center"><a href="#"><img src="images/product/70x84.jpg" alt="HUBLOT" title="WATCH"></a></td>
                          <td class="text-left product-name"><a href="#">Hublot</a> <span class="text-left price">$20.00</span>
                            <input class="cart-qty" name="product_quantity" min="1" value="1" type="number">
                          </td>
                          <td class="text-center"><a class="close-cart"><i class="fa fa-times-circle"></i></a></td>
                        </tr>
            ...
            while ($row = mysqli_fetch_assoc($result))
            {
              ?>
                  <div class="product-grid">
                    ...
                    <img src="images/product/<?=$row["img2"]?>" alt="Watch Classic" title="Watch Classic" class="img-responsive" /> 
                          </a>
                    ...
                    <div class="item">
                      <div class="product-thumb  mb_30">
                        <div class="image product-imageblock"> 
                          ...
                          <img data-name="product_image" src="images/product/product1.jpg" alt="Watch Classic" title="Watch Classic" class="img-responsive"> <img src="images/product/product1-1.jpg" alt="Watch Classic" title="Watch Classic" class="img-responsive"> 
                        </a>
                ...
                <div class="product-grid">
                  <div class="item">
                    <div class="product-thumb">
                      <div class="image product-imageblock"> 
                        <a href="product_detail_page.php">
                         <img data-name="product_image" src="images/product/product6.jpg" alt="Watch Classic" title="Watch Classic" class="img-responsive"> <img src="images/product/product6-1.jpg" alt="Watch Classic" title="Watch Classic" class="img-responsive">
                          </a>
                ...
                <div class="product-grid">
                  <div class="item">
                    <div class="product-thumb">
                      <div class="image product-imageblock">
                       <a href="product_detail_page.php"> 
                        <img data-name="product_image" src="images/product/product10.jpg" alt="Watch Classic" title="Watch Classic" class="img-responsive"> 
                        <img src="images/product/product10-1.jpg" alt="Watch Classic" title="Watch Classic" class="img-responsive"> 
                      </a>
