          ...
          <nav class="navbar">
            ...
            <div class="collapse navbar-collapse js-navbar-collapse">
              <ul id="menu" class="nav navbar-nav">
                ...
                <li> <a href="admin/infor_custom.php">Contact us</a></li>
              </ul>
            </div>
            <!-- /.nav-collapse -->
          </nav>
        ...
        <div class="col-sm-8 col-lg-9 mtb_20">
          ...
          <div class="row">
            ...
            <div class="col-md-8 col-xs-12 contact-form mb_50">
              <!-- Contact FORM <--></-->
              <div id="contact_form">
                <form action="functions/contact.php" id="contact_body" method="POST" >
                 
                  <input class="full-with-form" required="" type="text" name="c_name" placeholder="Name"  />
                  
                  <input class="full-with-form  mt_30" required="" type="email" name="c_email" placeholder="Email Address" />
                  
                  <input class="full-with-form  mt_30" required="" type="text" name="c_phone" placeholder="Phone Number" />

                  <input class="full-with-form  mt_30" required="" type="text" name="c_add" placeholder="Address" />
                  
                  <input class="full-with-form  mt_30" required="" type="text" name="c_subject" placeholder="Subject" />
                  
                  <textarea class="full-with-form  mt_30" required="" name="c_message" placeholder="Message"></textarea>
                  <!-- <button class="btn mt_30" type="submit">Send Message </button> -->
                  <input class="btn pull-right mt_30" value="Send Message" name="send" type="submit" /> 
                </form>
